      ...
      <CardContent className="p-6 space-y-5">
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as "text" | "url")}>
          <TabsList className="grid w-full grid-cols-2 bg-secondary/50">
            ...
            <TabsTrigger value="url" className="flex items-center gap-2 data-[state=active]:bg-background">
        ...
        <Button
          ...
          className="w-full h-12 text-base font-semibold glow-primary hover:glow-primary transition-all"
          size="lg"
        >
          {isLoading ? (
            <>
