  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(210 100% 60% / 0.15)" },
          "50%": { boxShadow: "0 0 40px hsl(210 100% 60% / 0.3)" },
        },
        shimmer: {
          "0%": { left: "-100%" },
          "100%": { left: "100%" },
        ...
        "blue-pulse": {
          "0%, 100%": { boxShadow: "0 0 0 0 hsl(210 100% 60% / 0.4)" },
          "50%": { boxShadow: "0 0 0 15px hsl(210 100% 60% / 0)" },
        },
        press: {
          "0%": { transform: "scale(1)" },
        ...
        lift: {
          ...
          "100%": { transform: "translateY(-4px)", boxShadow: "0 15px 40px hsl(210 100% 60% / 0.15)" },
        },
      },
      animation: {
        ...
        "blue-pulse": "blue-pulse 1.5s cubic-bezier(0.4, 0, 0.2, 1) infinite",
